				...
				<div className='flex flex-wrap items-center'>
					<div className='hidden w-full xl:block xl:w-1/2'>
						<div className='py-17.5 px-26 text-center'>
							<Link className='inline-block pr-7' href='/dashboard'>
								<Image className='dark:hidden' src={'/images/logo/logo-dark.svg'} alt='Logo' width={120} height={100} />
							</Link>
					...
					<div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2'>
						<div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
							<h2 className='mb-9 text-2xl font-bold text-black dark:text-black sm:text-title-xl2'>Reset Password</h2>
							<Formik
								innerRef={formikRef}
								initialValues={{
									email: email || null,
								...
								onSubmit={async (values, { resetForm }) => {
									try {
										...
										toast.error(`Reset Password Submission error! ${error.message}`)
									}
								}}>
								{({ errors, touched }) => {
									return (
										<Form>
											<div className='mb-6'>
												<label className='mb-2.5 block font-medium text-black dark:text-black'>Code</label>
												...
												{errors.otp && touched.otp && <div className='error-qoute'>{errors.otp}</div>}
											</div>
											<div className='mb-6'>
												<label className='mb-2.5 block font-medium text-black dark:text-black'>Password</label>
												<div className='relative'>
													<Field
														type='password'
														name='password'
													...
													<span
														...
														{!isPasswordVisible ? <PasswordSVG /> : <OpenPassword />}
													</span>
												</div>
												{errors.password && touched.password && <div className='error-qoute'>{errors.password}</div>}
											</div>
											<div className='mb-6'>
												<label className='mb-2.5 block font-medium text-black dark:text-black'>Re-type Password</label>
												<div className='relative'>
													<Field
														type='password'
													...
													<span
														...
														{!isConfirmPasswordVisible ? <PasswordSVG /> : <OpenPassword />}
													</span>
												</div>
												{errors.confirmPassword && touched.confirmPassword && (
													<div className='error-qoute'>{errors.confirmPassword}</div>
												)}
											</div>
											<div className='mb-5'>
												<button
	...
	return (
		<svg
			...
			<path
				opacity='0.5'
				fill='currentColor'
				d='M6 8h9V6q0-1.25-.875-2.125T12 3q-1.25 0-2.125.875T9 6H7q0-2.075 1.463-3.537T12 1q2.075 0 3.538 1.463T17 6v2h1q.825 0 1.413.588T20 10v10q0 .825-.587 1.413T18 22H6q-.825 0-1.412-.587T4 20V10q0-.825.588-1.412T6 8m0 12h12V10H6zm6-3q.825 0 1.413-.587T14 15q0-.825-.587-1.412T12 13q-.825 0-1.412.588T10 15q0 .825.588 1.413T12 17m-6 3V10z'
			/>
		</svg>
	)
}
const OTPSVG = () => {
	return (
		<svg
			...
			className='fill-current'
			fill='none'>
			<g opacity='0.5' fill='none' stroke='currentColor'>
				<path
					stroke-linejoin='round'
					d='M17.585 5.753c4.723-2.407 20.272-1.195 22.173 2.346c1.123 4.944-2.716 10.665-4.07 12.697c-3.734 5.605-5.469 8.522-9.154 4.588c-6.311-6.739-13.407-18.087-8.95-19.632z'
				/>
				<path d='M20.96 4.81S5.737 6.682 7.31 14.64c1.702 8.61 9.72 17.461 13.239 20.064c3.062 2.264 7.008 4.882 11.233-.577c4.497-5.81 12.295-21.943 7.524-26.614' />
				<path d='M19.293 15.432c2.96-.631 18.687-1.748 17.809 3.208' />
				<path
					stroke-linecap='round'
					stroke-linejoin='round'
					d='M6.953 43.025c.266.346.6.475 1.063.475h.642a1.08 1.08 0 0 0 1.08-1.081v-.005a1.08 1.08 0 0 0-1.08-1.08H7.95a1.082 1.082 0 0 1-1.083-1.083h0c0-.6.486-1.085 1.085-1.085h.638c.464 0 .797.129 1.063.475m24.112-.475h2.871M35.2 43.5v-4.334m-23.836 2.546a1.084 1.084 0 0 1 2.167 0V43.5m-2.167-2.871V43.5m2.167-1.788a1.084 1.084 0 0 1 2.167 0V43.5m3.792-1.084c0 .599-.485 1.084-1.083 1.084h0a1.084 1.084 0 0 1-1.084-1.084v-.704c0-.599.485-1.084 1.084-1.084h0c.598 0 1.083.485 1.083 1.084m0 1.788v-2.871m1.626 1.083c0-.598.485-1.083 1.083-1.083m-1.083 0V43.5'
				/>
			</g>
			<path
				fill='none'
				...
				stroke-linecap='round'
				stroke-linejoin='round'
				d='M24.366 39.735V43.5m-.569-2.871h1.138m5.768 2.871a1.436 1.436 0 0 1-1.436-1.436v-1.463a1.436 1.436 0 1 1 2.872 0v1.463c0 .793-.643 1.436-1.436 1.436m7.558 0v-4.334h1.42c.801 0 1.451.651 1.451 1.455s-.65 1.456-1.452 1.456h-1.419'
			/>
		</svg>
	)
}
