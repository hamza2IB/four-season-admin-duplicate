...
const ConfirmDeletion = ({ loading, setConfirmModel, handleDeleteRequest, message }) => {
	return (
		<div className='fixed top-0 left-0 z-999999 flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5 block'>
			<div className='w-full max-w-142.5 rounded-lg bg-white py-12 px-8 text-center dark:bg-boxdark md:py-15 md:px-17.5'>
				...
				<h3 className='mt-5.5 pb-2 text-xl font-bold text-black dark:text-black sm:text-2xl'>Are You Sure?</h3>
				<p className='mb-10'>Please confirm that you want to {message}.</p>
				<div className='-mx-3 flex flex-wrap gap-y-4'>
					<div className='w-full px-3 2xsm:w-1/2'>
						<button
							className='block w-full rounded border border-stroke bg-gray p-3 text-center font-medium text-black transition hover:border-meta-1 hover:bg-meta-1 hover:text-white dark:border-strokedark dark:bg-meta-4 dark:text-black dark:hover:border-meta-1 dark:hover:bg-meta-1'
