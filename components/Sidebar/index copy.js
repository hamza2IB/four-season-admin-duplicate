												...
												<ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
													<li>
														<Link
															...
															className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black ${
																pathname === '/forms/form-elements' && 'text-black'
															}`}>
															Form Elements
														</Link>
													</li>
													<li>
														<Link
															...
															className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black ${
																pathname === '/forms/form-layout' && 'text-black'
															}`}>
															Form Layout
														</Link>
													</li>
									...
									return (
										<React.Fragment>
											<Link
												href='javascript:void(0)'
												className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
													(pathname === '/dashboard/ui' || pathname.includes('ui')) && 'bg-graydark dark:bg-meta-4'
												}`}
												onClick={(e) => {
													e.preventDefault()
													sidebarExpanded ? handleClick() : setSidebarExpanded(true)
												...
												<ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
													<li>
														<Link
															...
															className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black ${
																pathname === '/dashboard/ui/alerts' && 'text-black'
															}`}>
															Alerts
														</Link>
													</li>
													<li>
														<Link
															...
															className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black ${
																pathname === '/dashboard/ui/buttons' && 'text-black'
															}`}>
															Buttons
														</Link>
													</li>
