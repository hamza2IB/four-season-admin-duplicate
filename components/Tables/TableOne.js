...
const TableOne = () => {
	return (
		<div className='rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1'>
			<h4 className='mb-6 text-xl font-semibold text-black dark:text-black'>Top Channels</h4>
				...
				{brandData.map((brand, key) => (
					<div
						...
						<div className='flex items-center gap-3 p-2.5 xl:p-5'>
							...
							<p className='hidden text-black dark:text-black sm:block'>{brand.name}</p>
						</div>
						...
						<div className='hidden items-center justify-center p-2.5 sm:flex xl:p-5'>
							<p className='text-black dark:text-black'>{brand.sales}</p>
						</div>
